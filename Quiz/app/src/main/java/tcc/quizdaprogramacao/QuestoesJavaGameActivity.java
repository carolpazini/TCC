...
public class QuestoesJavaGameActivity extends AppCompatActivity {
    Button buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesJavaActivity questoesJavaActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesJavaActivity = new QuestoesJavaActivity(this);
        questoesJavaActivity.getWritableDatabase();

        if (questoesJavaActivity.getAllOfTheQuestions().size() == 0) {
            questoesJavaActivity.allQuestion();
        }

        list = questoesJavaActivity.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesJavaGameActivity.this);
