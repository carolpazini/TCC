...
class QuestoesRede extends SQLiteOpenHelper {
    ...
    void allQuestion() {
        ...
        /*3*/   arraylist.add(new Questoes("O que significa a sigla UTP?","Unfinished Twister Pair (Par bagunçado e inacabado)","Unshield Twisted Pair (Par trançado sem blindagem)","Unmess Twisted Pair (Par trançado não bagunçado)","Unshield Twisted Pair (Par trançado sem blindagem)"));
        ...
        /*6*/   arraylist.add(new Questoes("São 3 topologias de rede comuns...","Barramento linear, estrela e anel","Roda, quadrado e piramide","Triângulo, circulo e árvore","Barramento linear, estrela e anel"));
        ...
        /*8*/   arraylist.add(new Questoes("Qual a principal função do protocolo FTP?","Garantir a segurança de uma transferência","Transferir arquivos de um computador para o outro","Verificar se a conexão é estável","Transferir arquivos de um computador para o outro"));
