...
public class QuestoesJavaGame extends AppCompatActivity {
    FButton buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesJava questoesJava;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesJava = new QuestoesJava(this);
        questoesJava.getWritableDatabase();

        if (questoesJava.getAllOfTheQuestions().size() == 0) {
            questoesJava.allQuestion();
        }

        list = questoesJava.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesJavaGame.this);
