...
public class QuestoesMobileGameActivity extends AppCompatActivity {
    Button buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesMobileActivity questoesMobileActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesMobileActivity = new QuestoesMobileActivity(this);
        questoesMobileActivity.getWritableDatabase();


        if (questoesMobileActivity.getAllOfTheQuestions().size() == 0) {
            questoesMobileActivity.allQuestion();
        }

        list = questoesMobileActivity.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesMobileGameActivity.this);
