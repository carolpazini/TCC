...
public class QuestoesProgWebGameActivity extends AppCompatActivity {
    Button buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesProgWebActivity questoesProgWebActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesProgWebActivity = new QuestoesProgWebActivity(this);
        questoesProgWebActivity.getWritableDatabase();


        if (questoesProgWebActivity.getAllOfTheQuestions().size() == 0) {
            questoesProgWebActivity.allQuestion();
        }

        list = questoesProgWebActivity.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesProgWebGameActivity.this);
