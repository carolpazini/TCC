...
public class QuestoesRedeGameActivity extends AppCompatActivity {
    Button buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesRedeActivity questoesRedeActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesRedeActivity = new QuestoesRedeActivity(this);
        questoesRedeActivity.getWritableDatabase();

        if (questoesRedeActivity.getAllOfTheQuestions().size() == 0) {
            questoesRedeActivity.allQuestion();
        }

        list = questoesRedeActivity.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesRedeGameActivity.this);
