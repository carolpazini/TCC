...
public class QuestoesFundamentosTIGame extends AppCompatActivity {
    FButton buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesFundamentosTI questoesFundamentosTI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesFundamentosTI = new QuestoesFundamentosTI(this);
        //Make db writable
        questoesFundamentosTI.getWritableDatabase();
        ...
        if (questoesFundamentosTI.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            questoesFundamentosTI.allQuestion();
        }

        //This will return us a list of data type Questoes
        list = questoesFundamentosTI.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesFundamentosTIGame.this);
