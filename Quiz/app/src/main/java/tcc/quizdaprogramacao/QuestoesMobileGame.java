...
public class QuestoesMobileGame extends AppCompatActivity {
    FButton buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesMobile questoesMobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questoesMobile = new QuestoesMobile(this);
        //Make db writable
        questoesMobile.getWritableDatabase();
        ...
        if (questoesMobile.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            questoesMobile.allQuestion();
        }

        //This will return us a list of data type Questoes
        list = questoesMobile.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesMobileGame.this);
