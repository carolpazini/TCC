...
public class QuestoesTrialGameActivity extends AppCompatActivity {
    Button buttonA, buttonB, buttonC;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuestoesTrialActivity questoesTrialActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trial_game_main);
        ...
        questoesTrialActivity = new QuestoesTrialActivity(this);
        questoesTrialActivity.getWritableDatabase();

        if (questoesTrialActivity.getAllOfTheQuestions().size() == 0) {
            questoesTrialActivity.allQuestion();
        }

        list = questoesTrialActivity.getAllOfTheQuestions();
    ...
    public void gameWon() {
        Intent intent = new Intent(this, GanhouTrialActivity.class);
    ...
    public void gameLostPlayAgain() {
        Intent intent = new Intent(this, PlayAgainTrialActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    public void timeUp() {
        Intent intent = new Intent(this, TempoTrialActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuestoesTrialGameActivity.this);
